...
class ZeroTrustGatekeeper:
    ...
    def get_live_ledger(self) -> dict:
        """
        STRICT READ-ONLY SSOT: Reads the unified Admin ledger directly from the mounted 
        Docker volume. The Fog node has zero authority to modify this file.
        """
    ...
    def filter_node_updates(self, tier: str, strategy_name: str, server_round: int, results: list, active_nonces: dict) -> list:
        ...
        # Pull the live state of the ledger exactly once at the start of every round.
        ...
        for client_proxy, fit_res in results:
            ...
            # Pass the read-only ledger down for stateless verification
